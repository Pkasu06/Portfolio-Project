...
function About() {
    return (
        <div className="container text-center w-full p-4 my-20 flex flex-col items-center gap-y-4 md:max-w-7xl mx-auto md:flex-row md:items-center0 justify between" id="About">
            <div className="about w-full p-2 rounded-lg border border-blue-800 bg-card text-card-foreground shadow-sm text-left">
                ...
                <div className="content px-2 mt-2">
                    I have around 3 years of experience as UI Developer with hands on experience in HTML, CSS, Less. 
