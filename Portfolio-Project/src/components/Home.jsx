...
function Home() {
    return (
        <div className="container text-center w-full p-4 mt-10 flex flex-col items-center gap-y-4 md:max-w-7xl mx-auto md:flex-row md:items-center0 justify between" id="Home">
            ...
            <div className="name w-full p-2 md:basis-3/5 bg-card text-card-foreground shadow-sm text-left">
                <h1 className="font-bold text-[40px] md:text-6xl text-primary p-2">I am Lakshmiprasanna Kasu</h1>
