    ...
    return (
        <div className="container text-center w-full p-4 mt-10 flex flex-col items-center gap-y-4 md:max-w-7xl mx-auto md:flex-row md:items-center0 justify between" id="Home">
            ...
            <div className="name w-full p-2 bg-card text-card-foreground shadow-sm text-center">
                ...
                {/* <a href="/" download className="inline-block text-white border bg-blue-700 hover:bg-white focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 m-3 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Resume</a> */}
